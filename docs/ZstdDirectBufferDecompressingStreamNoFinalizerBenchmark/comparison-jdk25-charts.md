# ZstdDirectBufferDecompressingStreamNoFinalizerBenchmark benchmark comparison — JDK 25

Implementations: `orig` — zstd-jni `1.5.7-16-LOCAL`; `ffm` — branch [support-ffm-api-v3](https://github.com/zygiert1990/zstd-jni/tree/support-ffm-api-v3).
